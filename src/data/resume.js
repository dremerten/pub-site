...
export const experienceData = [
  {
    ...
    highlights: [
      ...
      "Key contributor to the release cycles of HSTS, AsperaProxy, HTTP-Gateway, and OTFV (Out-of-file-validation) virus detection ensuring stability and timely delivery.",
      ...
      "Helped Architect and implement high-availability Faspex5 deployments. Responsible for validation testing for both on-prem (MariaDB Galera) and cloud (RDS HA) ensuring compatibility.",
      ...
      "Coordinated with External Security Teams and Pentest Teams for annual security Testing for entire WebApp Portfolio.",
...
// Commented out experience for reference
