...
const ResumePDF = "/files/RAM2026-v3.pdf";
const ResumeDOCX = "/files/RAM2026-v3.docx";
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              {location.pathname !== "/home" && (
                <Link to="/home" className={`flex flex-row gap-1.5 items-center px-2.5 py-1.5 rounded-lg text-xs sm:text-sm transition-all hover:scale-105 ${location.pathname === "/home"
            ...
            <div className="flex md:hidden gap-2">
              <Link to="/overview" className={`flex flex-row gap-2 items-center px-3 py-2 rounded-lg text-sm md:text-base transition-all hover:scale-105 ${location.pathname === "/overview"
                ? "bg-blue-600 text-white shadow-lg shadow-blue-600/30"
              ...
              <Link to="/projects" className={`flex flex-row gap-2 items-center px-3 py-2 rounded-lg text-sm md:text-base transition-all hover:scale-105 ${isProjectsPath
                ? "bg-blue-600 text-white shadow-lg shadow-blue-600/30"
                : "bg-[#0a0a0a] text-gray-300 hover:bg-[#0f0f0f] border border-[rgba(255,255,255,0.08)]"
                }`}>
              ...
              <Link to="/resume" className={`flex flex-row gap-2 items-center px-3 py-2 rounded-lg text-sm md:text-base transition-all hover:scale-105 ${location.pathname === "/resume"
                ? "bg-blue-600 text-white shadow-lg shadow-blue-600/30"
                : "bg-[#0a0a0a] text-gray-300 hover:bg-[#0f0f0f] border border-[rgba(255,255,255,0.08)]"
                }`}>
                ...
                <NavigationMenuList className="gap-1">
                  <NavigationMenuItem>
                    <NavigationMenuLink asChild>
                      <Link to="/overview" className={`flex items-center gap-1.5 px-2 py-1 h-auto rounded-lg transition-all cursor-pointer text-xs ${location.pathname === "/overview"
                  ...
                  <NavigationMenuItem>
                    <NavigationMenuLink asChild>
                      <Link to="/projects" className={`flex items-center gap-1.5 px-2 py-1 h-auto rounded-lg transition-all cursor-pointer text-xs ${isProjectsPath
                        ? "bg-blue-600 text-white"
                        : "text-white hover:text-blue-300 hover:bg-white/10"
                        }`}>
                  ...
                  <NavigationMenuItem>
                    <NavigationMenuLink asChild>
                      <Link to="/resume" className={`flex items-center gap-1.5 px-2 py-1 h-auto rounded-lg transition-all cursor-pointer text-xs ${location.pathname === "/resume"
                        ? "bg-blue-600 text-white"
                        : "text-white hover:text-blue-300 hover:bg-white/10"
                        }`}>
